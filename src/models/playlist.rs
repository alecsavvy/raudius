...
pub struct Playlist {
    ...
    pub artwork: Option<Box<crate::models::PlaylistArtwork>>,
...
impl Playlist {
    pub fn new(id: String, is_album: bool, playlist_name: String, repost_count: i32, favorite_count: i32, total_play_count: i32, user: crate::models::User) -> Playlist {
        Playlist {
            artwork: None,
            description: None,
            id,
